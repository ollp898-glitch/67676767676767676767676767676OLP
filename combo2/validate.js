...
function validate(sourceDir,root){
 ...
 const coverage={normal:{matched:0,unmatched:0,ambiguous:0},esports:{}};
 ...
 const recomputed=comparison(out.polymarket,out.bookmakers,e.facts);assert.deepEqual(out.betfair,recomputed.betfair);assert.deepEqual(out.comparison,recomputed.comparison);
